...
## staging dir for CraftCMS download and homegrown scripts
mkdir /tmp/crafttmp
...
# Add the snapads_db db - WARNING! INLINE PASSWORD!!! FIX THIS, PROBABLY WITH mysql_config_editor
