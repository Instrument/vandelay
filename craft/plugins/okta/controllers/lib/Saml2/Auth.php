    ...
    public function processResponse($requestId = null)
    {
        ...
        if (isset($_POST) && isset($_POST['SAMLResponse'])) {
            ...
            if ($response->isValid($requestId)) {
                ...
                $userattrs =  $response->getAttributes();

                //IF USER IS VALID IN OKTA BUT DOESN'T HAVE A CRAFT ROLE, THEY DON'T BELONG HERE - COMMENTED OUT FOR THE TIME BEING
//                if (!array_key_exists("Role", $userattrs)) {
//                    $this->_errors[] = 'no Craft Role set in Okta';
//                    Craft::log("user doesn't have a Role", LogLevel::Error);
//                } else {
//                    if($userattrs["Role"][0] == null){
//                        Craft::log("user doesn't have a Role", LogLevel::Error);
//                        $this->_errors[] = 'no Craft Role set in Okta';
//                    }
//                }
